...
static struct gpio_keys_button gpio_button[] = {
	...
	{KEY_BRIGHTNESSUP,          -1, 1, "volume_up",     EV_KEY, 0, 20},	// remap volume keys to brightness keys
	{KEY_BRIGHTNESSDOWN,        -1, 1, "volume_down",   EV_KEY, 0, 20},	// remap volume keys to brightness keys
