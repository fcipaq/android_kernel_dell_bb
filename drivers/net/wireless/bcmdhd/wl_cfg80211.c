 ...
 *
 * $Id: wl_cfg80211.c 589618 2015-09-30 08:51:19Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
	...
	if (event == WLC_E_ACTION_FRAME_RX) {
		...
		if (wl_cfgp2p_is_pub_action(&mgmt_frame[DOT11_MGMT_HDR_LEN],
			...
			(void) sd_act_frm;
				...
				(mgmt_frame[DOT11_MGMT_HDR_LEN] == TDLS_VENDOR_SPECIFIC)) {
			dhd_pub_t *dhdp;
			cfg = g_bcm_cfg;
